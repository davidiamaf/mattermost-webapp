...
describe("BloomOperation", () => {
    it("can find the thing", () => {
        ...
        expect(bloomMaybe(bloom.bloom, "NOT")).not.toBeTruthy();
        expect(bloomMaybe(bloom.bloom, "DOd")).toBeTruthy();
        expect(bloomMaybe(bloom.bloom, "DOD")).toBeTruthy();
    });
});
...
describe('autolinkAcronyms', () => {
    ...
    function runSuccessfulAcronymTests(leadingText = '', trailingText = '') {
        acronymTestCases.forEach((testCase) => {
            ...
            const output = autolinkAcronyms(text, tokens, bloom);
            let expected = text; //`${leadingText}{trailingText}`;
            ...
            const index = `$MM_ACRONYM${acronym.toLowerCase()}$`;
            expect(output).toBe(`${leadingText}$MM_ACRONYM${acronym.toLowerCase()}$${trailingText}`);
            expect(tokens.get(index)?.value).toBe(acronymExpanded(bloom.terms.get(acronym.toLowerCase()), acronym));
    ...
    function runUnsuccessfulAcronymTests(leadingText = '', trailingText = '') {
        acronymTestCases.forEach((testCase) => {
            ...
            const output = autolinkAcronyms(text, tokens, bloom);
            const index = `$MM_ACRONYM${acronym.toLowerCase()}$`;
            expect(tokens.get(index)?.value).toBeUndefined();
    ...
    test('Acronym should highlight properly with a leading space', () => {
        runSuccessfulAcronymTests(' ', '');
    });
    test('Acronym should highlight properly with a trailing space', () => {
        runSuccessfulAcronymTests('', ' ');
    });
    test('Acronym should highlight properly with a leading period', () => {
        runSuccessfulAcronymTests('.', '');
    });
    test('Acronym should highlight properly with a trailing period', () => {
        runSuccessfulAcronymTests('', '.');
    });
    test('Acronym should highlight properly with multiple leading and trailing periods', () => {
        runSuccessfulAcronymTests('...', '...');
    });
    test('Acronym should highlight properly with a leading dash', () => {
        runSuccessfulAcronymTests('-', '');
    });
    test('Acronym should highlight properly with a trailing dash', () => {
        runSuccessfulAcronymTests('', '-');
    });
    test('Acronym should highlight properly with multiple leading and trailing dashes', () => {
        runSuccessfulAcronymTests('---', '---');
    });
    test('Acronym should highlight properly with a trailing underscore', () => {
        runSuccessfulAcronymTests('', '____');
    });
    test('Acronym should highlight properly with multiple trailing underscores', () => {
        runSuccessfulAcronymTests('', '____');
    });
    test('Acronym should highlight properly within a typical sentance', () => {
        runSuccessfulAcronymTests('This is a typical sentance, ', ' check out this sentance!');
    });
    test('Acronym should highlight with a leading underscore', () => {
        runSuccessfulAcronymTests('_');
    });

    // cases where highlights should be unsuccessful
    test('Acronym should not highlight when the last part of a word', () => {
        runUnsuccessfulAcronymTests('testing');
    });
    test('Acronym should not highlight when in the middle of a word', () => {
